...
try:
    ...
    outfile.write("/bin/echo \"Inside initramfs init...\"\n")
    ...
    outfile.write("/bin/echo \"Executing veritysetup...\"\n")
    outfile.write("/bin/veritysetup --verbose --data-block-size=1024 --hash-block-size=1024 create " + verity_name + " /dev/sda" + str(data_num) + " /dev/sda" + str(hash_num) + " " + root_hash + "\n")
    outfile.write("wait\n")
    ...
    outfile.write("/bin/echo \"Executing switch_root...\"\n")

    outfile.write("exec switch_root /mnt/root /sbin/init")
    outfile.close()
except IOError:
    print("I/O error")
